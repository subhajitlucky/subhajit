...
That is why this portfolio is structured around indexable content and project evidence. The homepage gives the short version. Project pages explain problem, workflow, architecture, decisions, tradeoffs, and next improvements. Blog posts add longer notes on engineering thinking.
...
I use my name where it helps the reader understand authorship and context. That is different from keyword stuffing, which makes a page worse for humans and less trustworthy for search.
